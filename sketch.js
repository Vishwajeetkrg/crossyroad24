...
function setup() {
  ...
  // no use of calling preload. that's underrated.
...
if (gameState = "win") {
  ...
  fill("green");
  textSize(40);
  text("Congratulations! The biggest achievement in history! Crossing a road! ", width/2-250, -1700);
...
function keyPressed() {
  if (keyCode == UP_ARROW) {
   ...
   } else if (logGroup1.isTouching(player.spt)) {
     player.spt.x -= 30;
   }
